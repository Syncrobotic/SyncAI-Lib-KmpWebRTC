...
/**
 * WasmJS implementation of session-based AudioPushPlayer.
 */
@Composable
...
/**
 * WasmJS implementation of AudioPushPlayer (legacy config-based API).
 */
...
/**
 * WasmJS implementation of AudioPushClient.
 */
actual class AudioPushClient actual constructor(
    ...
    private val impl = WasmJsAudioPushClient(
        config = config,
        onStateChange = onStateChange
    )
...
// Helper for console logging in WasmJS
...
/**
 * Internal WasmJS audio push controller implementation.
 */
internal class WasmJsAudioPushClient(
    ...
    private fun log(message: String) {
        consoleLog("[AudioPushPlayer] $message")
    }
